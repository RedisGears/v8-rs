...
#ifndef V8INCLUDE_V8_UNWINDER_H_
#define V8INCLUDE_V8_UNWINDER_H_

#include <memory>

#include "../v8include/v8-embedder-state-scope.h"  // NOLINT(build/include_directory)
...
#endif  // V8INCLUDE_V8_UNWINDER_H_
