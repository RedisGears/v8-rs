...
#ifndef V8INCLUDE_CPPGC_PREFINALIZER_H_
#define V8INCLUDE_CPPGC_PREFINALIZER_H_

#include "../../v8include/cppgc/internal/compiler-specific.h"
#include "../../v8include/cppgc/internal/prefinalizer-handler.h"
...
#endif  // V8INCLUDE_CPPGC_PREFINALIZER_H_
