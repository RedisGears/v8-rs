...
#ifndef V8INCLUDE_CPPGC_INTERNAL_NAME_TRAIT_H_
#define V8INCLUDE_CPPGC_INTERNAL_NAME_TRAIT_H_

#include <cstddef>
#include <type_traits>

#include "../../../v8include/cppgc/name-provider.h"
...
#endif  // V8INCLUDE_CPPGC_INTERNAL_NAME_TRAIT_H_
