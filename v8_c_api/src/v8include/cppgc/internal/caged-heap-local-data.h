...
#ifndef V8INCLUDE_CPPGC_INTERNAL_CAGED_HEAP_LOCAL_DATA_H_
#define V8INCLUDE_CPPGC_INTERNAL_CAGED_HEAP_LOCAL_DATA_H_
...
#endif  // V8INCLUDE_CPPGC_INTERNAL_CAGED_HEAP_LOCAL_DATA_H_
