...
#ifndef V8INCLUDE_CPPGC_INTERNAL_COMPILER_SPECIFIC_H_
#define V8INCLUDE_CPPGC_INTERNAL_COMPILER_SPECIFIC_H_
...
#endif  // V8INCLUDE_CPPGC_INTERNAL_COMPILER_SPECIFIC_H_
